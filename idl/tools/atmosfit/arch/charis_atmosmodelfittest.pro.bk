pro charis_atmosmodelfittest,planetspec=planetspec,planetcovar=planetcovar,planetphot=planetphot,grid=grid,pick=pick,band=band,delay=delay,saveplot=saveplot,metals=metals,calcind=calcind,justind=justind,distance=distance,extendplot=extendplot
